...
public class SpielFeld {
    ...
    public Chess.Game.Figur occupied;
    public int FeldLängeX,FeldLängeY;
    public Chess.Game.FeldPosition coordinate;

    private boolean active;
    private boolean allowed;
    private boolean[][][] attacked = new boolean[2][8][8]; //White = 0 => von Weiß angegriffen 2. & 3. []: Koordinaten von Angreifer

    public SpielFeld(boolean color, Chess.Game.FeldPosition coordinate, int FeldLängeX, int FeldLängeY){
        this.color = color;
        this.active = active;
    ...
    public void setFigur(Chess.Game.Figur occupied){
        this.occupied = occupied;
